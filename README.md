...
pitcher_summarized_data.csv:
      ...
      5. Swing+: A pitch's ability to generate swings from a batter. A higher score means that pitch is swung at by the batter more. 100 is league average.
      
      6. Stuff+: A pitch's ability to move with velocity and movement. A higher score means that pitch is able move with more speed and movement. 100 is league average.
